...
import eu.sia.gateway.domain.Job;
import eu.sia.gateway.repository.JobRepository;
import eu.sia.gateway.repository.search.JobSearchRepository;
...
public class JobResourceIT {
     ...
     *
     * @see eu.sia.gateway.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
